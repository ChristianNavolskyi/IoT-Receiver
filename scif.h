/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/Users/user/Documents/GitHub/IoT-Receiver/ADCTrigger.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2019-04-15 13:03:53.169
  * - <b>Computer</b>:         DESKTOP-GBH17Q9
  * - <b>User</b>:             user
  *
  ...
  * - adc level trigger:
  *     - <b>A: The first ADC input DIO30 0</b>: DIO30
  *     - <b>A: The first ADC input DIO30 1</b>: DIO29
  *
  *
...
/// adc level trigger I/O mapping: The first ADC input DIO30
#define SCIF_ADC_LEVEL_TRIGGER_DIO_AADC_INPUT1 { 30, 29 }
...
typedef struct {
    uint16_t pAuxioAAdcInput1[2]; ///< I/O mapping: The first ADC input DIO30
